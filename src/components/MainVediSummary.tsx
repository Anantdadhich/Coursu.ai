...
export const MainVideoSummary = ({
  ...
  return (
    <div className="flex-[2] mt-8 sm:mt-12 md:mt-16 mx-4 sm:mx-6 rounded-lg shadow-xl p-4 sm:p-5 md:p-6 text-black dark:text-blue bg-neutral-300 dark:bg-neutral-900 border border-gray-200 dark:border-gray-700">
      <div className="flex items-center space-x-2 text-black dark-text-white">
        <BookOpen size={18} className="sm:w-5 sm:h-5 text-black dark:text-white" />
        <h4 className="text-md sm:text-sm uppercase text-black dark:text-white">
